    ...
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent>
        ...
        <div className="grid flex-1 auto-rows-min gap-3 px-4">
          <Link href="/" className={className} onClick={handleClose}>
            Home
          </Link>
          <Link href="/movies" className={className} onClick={handleClose}>
            Movies
          </Link>
          <Link href="/series" className={className} onClick={handleClose}>
            TV Series
          </Link>
          <Link href="/privacy" className={className} onClick={handleClose}>
            Privacy
          </Link>
        </div>
      </SheetContent>
