        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <Button
              variant="outline"
              size="sm"
              className="h-8 w-8 p-0 border-white/10 bg-white/5"
              disabled
            >
  ...
  return (
    <div className={cn("mt-4", className)}>
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <Button
            ...
            className="h-8 w-8 p-0 border-white/10 bg-white/5 text-foreground hover:bg-white/10"
          >
            <ChevronLeft className="w-4 h-4" />
          </Button>
          <Button
      ...
      <div
        ref={containerRef}
        className={cn(
          "edge-fade flex gap-3 overflow-x-auto scrollbar-hide select-none py-2 min-w-0 content-visibility-auto contain-paint",
